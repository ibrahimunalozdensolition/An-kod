...
function AuthProvider({ children }) {
    ...
    const refreshUser = async ()=>{
        if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"].currentUser) {
            const userData = await fetchUserData(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"].currentUser);
            setUser(userData);
        }
    };
    ...
    const signUp = async (email, password, phoneNumber)=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sendEmailVerification"])(firebaseUser);
    };
    const signOut = async ()=>{
...
//# sourceMappingURL=lib_7d0987c2._.js.map