    ...
    const savePage = async (status)=>{
        ...
        try {
            ...
            if (basicInfo.profilePhoto) {
                pageData.profilePhoto = URL.createObjectURL(basicInfo.profilePhoto);
            }
            if (basicInfo.coverPhoto) {
                pageData.coverPhoto = URL.createObjectURL(basicInfo.coverPhoto);
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5ed33450._.js.map