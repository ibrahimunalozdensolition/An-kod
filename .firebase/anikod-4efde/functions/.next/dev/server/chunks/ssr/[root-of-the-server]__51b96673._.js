...
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "AIzaSyAXwcOEY2Xhtma4vvJYuuHA8z6oCI-wpR4"),
    authDomain: ("TURBOPACK compile-time value", "anikod-4efde.firebaseapp.com"),
    projectId: ("TURBOPACK compile-time value", "anikod-4efde"),
    storageBucket: ("TURBOPACK compile-time value", "anikod-4efde.firebasestorage.app"),
    messagingSenderId: ("TURBOPACK compile-time value", "875829063021"),
    appId: ("TURBOPACK compile-time value", "1:875829063021:web:b4cc9f9526db863da87e64")
};
...
"[project]/lib/context/AuthContext.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AuthProvider({ children }) {
    ...
    const refreshUser = async ()=>{
        if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"].currentUser) {
            const userData = await fetchUserData(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"].currentUser);
            setUser(userData);
        }
    };
    ...
    const signUp = async (email, password, phoneNumber)=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sendEmailVerification"])(firebaseUser);
    };
    const signOut = async ()=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__51b96673._.js.map