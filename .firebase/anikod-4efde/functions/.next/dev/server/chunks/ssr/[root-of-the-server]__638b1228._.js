...
function CreateMemoryPage() {
    ...
    const savePage = (status)=>{
        ...
        const newPage = {
            ...
            deathDate: basicInfo.deathDate,
            bio: basicInfo.bio,
            profilePhoto: basicInfo.profilePhoto ? URL.createObjectURL(basicInfo.profilePhoto) : undefined,
            coverPhoto: basicInfo.coverPhoto ? URL.createObjectURL(basicInfo.coverPhoto) : undefined,
            memories: memories,
            settings: settings,
            status: status,
            slug: slug,
        ...
        const existingPages = JSON.parse(localStorage.getItem('memoryPages') || '[]');
        existingPages.push(newPage);
        localStorage.setItem('memoryPages', JSON.stringify(existingPages));
        return true;
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__638b1228._.js.map